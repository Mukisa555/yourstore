...
Version 4.1.12 - June 19, 2024
- Compatible with Woocommerce 9.0.x
- [FIX] Fix Out Of Date the file "urna\woocommerce\loop\add-to-cart.php" 

Version 2.4.11  - June 17, 2024
- Compatible with Slider Revolution Responsive 6.7.x
- Compatible with Woocommerce 8.9.x
- Compatible with Elementor 3.22.x
- Compatible with WPBakery Page Builder 7.7.x
- [FIX] Fix the Elementor version 3.22.x not working
- [FIX] Fix the missing menu error after importing the demo
- [FIX] Fix the error of not receiving short code in theme options 'HTML before Add To Cart button (Global)' and 'HTML after Add To Cart button (Global)'
- [FIX] Fix the error of the mobile menu button click

Version 2.4.10  - April 09, 2024
- Compatible with Slider Revolution Responsive 6.7.x
- [FIX] Fix the missing menu error after importing the demo
- [FIX] Fix the style error on the Elementor Pro

Version 2.4.9  - March 14, 2024
- Compatible with Elementor 3.20.x
- [FIX] Fix the 'Urna Site Logo' error with the missing link

Version 2.4.8  - February 23, 2024
- Compatible with Elementor 3.19.x
- Compatible with WPBakery Page Builder 7.5.x
- Compatible with WooCommerce 8.6.x
- [ADD NEW] Add style button color to theme color only Dokan Free version
- [FIX] Fix the error of the image and title duplicated  in the editor editing section of the product item the Elementor

Version 2.4.7  - December 06, 2023
...
Version 2.4.6  - November 23, 2023
...
Version 2.4.5  - September 03, 2023
