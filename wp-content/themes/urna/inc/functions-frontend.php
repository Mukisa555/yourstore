...
if (! function_exists('urna_tbay_render_breadcrumbs')) {
    function urna_tbay_render_breadcrumbs()
    {
        ...
        $show_page_title = get_post_meta($post->ID, 'tbay_page_show_page_title', true);
...
if (! function_exists('urna_tbay_render_title')) {
    function urna_tbay_render_title()
    {
        ...
        if (is_page() && is_object($post)) {
            $show = get_post_meta($post->ID, 'tbay_page_show_breadcrumb', true);
            $show_title = get_post_meta($post->ID, 'tbay_page_show_page_title', true);

            if (isset($show) && $show != 'yes' && $show_title == 'yes') {
