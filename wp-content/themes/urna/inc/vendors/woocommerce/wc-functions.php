...
if (! function_exists('urna_woocommerce_sub_categories')) {
    ...
    function urna_woocommerce_sub_categories($echo = true)
    {
        ...
        $loop_start = apply_filters('urna_get_woocommerce_sub_categories', ob_get_clean());
...
if (! function_exists('urna_woocommerce_maybe_show_product_subcategories')) {
    add_filter('urna_get_woocommerce_sub_categories', 'urna_woocommerce_maybe_show_product_subcategories');
...
if (! function_exists('urna_woo_show_product_loop_outstock_flash')) {
    ...
    function urna_woo_show_product_loop_outstock_flash($html)
    {
        ...
        || ( $product->is_type('variable') && urna_is_variable_product_out_of_stock( $product ) ) ) {
            $return_content .= '<span class="out-stock"><span>' . esc_html__('Out of stock', 'urna') .'</span></span>';
        }
...
if (! function_exists('urna_woo_fix_form_search_cate_empty_woof_new_version')) {
    add_action( 'admin_init', 'urna_woo_fix_form_search_cate_empty_woof_new_version', 10 );
    function urna_woo_fix_form_search_cate_empty_woof_new_version()
    {
