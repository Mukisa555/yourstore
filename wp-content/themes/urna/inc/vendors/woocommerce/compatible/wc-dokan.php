...
if (!function_exists('urna_body_classes_woocommerce_dokan_free')) {
    function urna_body_classes_woocommerce_dokan_free($classes)
    {
        if ( !class_exists('Dokan_Pro') ) {
            $classes[] = 'tb-dokan-free';
        }

        return $classes;
    }
    add_filter('body_class', 'urna_body_classes_woocommerce_dokan_free');
}